...
// Minimal cross-device smoke suite run by every desktop Playwright lane. The
// real-device (iOS/Android) lane mirrors these same assertions over Selenium in
// tests/browserstack/realdevice-smoke.js. It proves the three things that
// actually break per browser: the pool unlocks on the user gesture, real MP3
// decodes and plays, and a gestureless next() advances and plays the next track.
